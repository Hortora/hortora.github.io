...
entry: "02"
type: session
excerpt: "I came in to fix retrieval. We fixed it in an hour. Then we didn't stop."
---
# The Session: One Fix, One Afternoon, One Project

<img align="left" width="160" src="/blog/hortora-blog2-img1-retrieval.png" alt="Three-tier retrieval funnel">I came in to fix retrieval. We fixed it in an hour.
...
<img align="left" width="160" src="/blog/hortora-blog2-img3-federation.png" alt="Federation model">The team case forced the federation model. If someone on my team runs their own garden, how does knowledge flow between us without centralising everything?
